		...
		<div id="android-downloads">
			...
			#FiOS WEP Calculator
				array(
					...
					true, #Whether or not the application has screenshots available
					#Application's Description
					"FiOS WEP Calculator lets you easily calculate the <em>default</em> WEP key for an Actiontec MI424WR router (Generations 1 & 2). 
			...
			#InfiniteSMS Limit Remover
				array(
					...
					without the annoying pop-up messages. This requires a <em><a target=\"_blank\" href=\"http://www.androidpolice.com/2010/04/15/rooting-explained-top-5-benefits-of-rooting-your-android-phone/\">rooted device</a></em>. 
			...
			#Simple Dice
				array(
					...
					"simple_dice_rolling", #Shortened Application Name
					true, #Whether or not the application has screenshots available
					#Application's Description
			...
			#EliteGuard
				array(
					...
					"eliteguard_sms_protection", #Shortened Application Name
					true, #Whether or not the application has screenshots available
					#Application's Description
			...
			#Currency Converter
				array(
					...
					"currency_converter", #Shortened Application Name
					true, #Whether or not the application has screenshots available
					#Application's Description
			...
			#Find The Mouse
				array(
					...
					"find_the_mouse", #Shortened Application Name
					true, #Whether or not the application has screenshots available
					#Application's Description
			...
			#Clippy
				array(
					...
					"clippy_clipboard_manager", #Shortened Application Name
					true, #Whether or not the application has screenshots available
					#Application's Description
			...
			#Catch The Ball
				array(
					...
					"catch_the_ball", #Shortened Application Name
			...
			#Self Destruct
				array(
					...
					"self-destruct", #Shortened Application Name
					false, #Whether or not the application has screenshots available
					#Application's Description
